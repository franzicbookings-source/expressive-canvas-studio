...
import { z } from "zod";
import { Loader2, MessageCircle, Mail, MapPin, Clock } from "lucide-react";
        ...
        <aside className="md:col-span-4 space-y-4">
          ...
          <Reveal delay={200}>
            <div className="rounded-3xl bg-card border border-border/70 p-6">
              ...
              <h3 className="display mt-4 text-2xl">Hours</h3>
              <p className="mt-1 text-sm text-muted-foreground">Mon–Fri · 08:00–18:00 SAST</p>
              <p className="mt-2 text-xs text-muted-foreground">Replies within 24 hours, every business day.</p>
            </div>
          </Reveal>
        </aside>

        <Reveal delay={120} className="md:col-span-8">
          <form onSubmit={onSubmit} className="rounded-3xl bg-card border border-border/70 p-6 md:p-10 space-y-5">
