...
const About = () => (
  <>
    <SEO
      ...
      description="Ntombii Tech is a Newcastle-born digital studio. We design and build mobile-first websites and brand systems for African companies."
      path="/about"
        ...
        <Reveal className="md:col-span-5">
          <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-card aspect-[4/5]">
            <img
              ...
              alt="Sabelo Ndlovu, Technoking and founder of Ntombii Tech, wearing a branded Ntombii Tech shirt"
